...
/**
 * AvatarGroup — stacked avatars with hover lift + spring tooltip.
 * Uses shadcn tokens: bg-primary / text-primary-foreground / border-background.
 *
 * @param {Array<{src: string, alt?: string, label?: string}>} avatars
 * @param {number} maxVisible — avatars shown before the "+N" badge
 * @param {number} size       — avatar diameter in px
 * @param {number} overlap    — negative spacing between avatars in px
 */
const AvatarGroup = ({
  avatars,
  maxVisible = 5,
