...
const LINE_BASE_LIGHT = { r: 17, g: 17, b: 17, a: 0.1 };
...
export default function KineticGrid({
    ...
    const draw = useCallback(
        (now) => {
            ...
            // Theme-aware palette — follows the app's `.dark` class toggle
