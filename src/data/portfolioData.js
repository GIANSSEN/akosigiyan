...
export const projects = [
    ...
    },
    {
        ...
        description: 'Gemini-integrated chatbot assistant for portfolio websites with context-aware, stateful responses.',
        url: 'github.com/Gianssen',
        link: '#',
        linkLabel: 'IN DEVELOPMENT',
        tech: ['react', 'nodedotjs', 'python'],
    },
    {
        title: 'E-Commerce Platform',
        role: 'Full-Stack Developer',
        description: 'Full-stack e-commerce solution with React frontend, Laravel backend API, and PostgreSQL database.',
        url: 'github.com/Gianssen',
        link: '#',
        linkLabel: 'IN DEVELOPMENT',
...
export const terminalCommands = {
    ...
    projects: [
        ...
        { text: "01  CJ's Minimart POS System", cls: 'success' },
        ...
        { text: '', cls: 'output' },
        { text: '02  Weather Globe App', cls: 'success' },
        ...
        { text: '', cls: 'output' },
        { text: '03  AI Chatbot  [In Development]', cls: 'warning' },
        { text: '04  E-Commerce Platform  [In Development]', cls: 'warning' },
    ],
    experience: [
